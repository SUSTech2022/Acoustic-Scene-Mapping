...
addpath("D:\SUSTech\AudioMap\code\soundMapping_matlab\mbss_locate\v2.0\localization_tools\");

%% Input File & Mic config
% Input wav file recorded by sensor corresponding to above locations
fileName = "D:\SUSTech\AudioMap\exp_data\0128_exp\audio\part1\sub04.wav";  % see readme.txt
...
% localization method
angularSpectrumMeth        = 'MVDR'; % Local angular spectrum method {'GCC-PHAT' 'GCC-NONLIN' 'MVDR' 'MVDRW' 'DS' 'DSW' 'DNM'}
...
nsrce                      = 4;          % Number of sources to be detected
...
% Other parameters
speedOfSound               = 343;        % Speed of sound (m.s-1) - typical value: 343 m.s-1 (assuming 20癈 in the air at sea level)
